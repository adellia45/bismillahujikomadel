...
<div class="row g-4 mb-4">
    ...
    <!--galeri-->
    <div class="col-md-4">
        <div class="card border-0r shadow-sm h-100">
            <div class="card-body p-4">
                <div class="d-flex align-items-center gap-3 mb-2">
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="#" class="btn btn-sm btn-outline-primary fw-semibold">Lihat Semua</a>
                </div>
                    ...
                    <div class="card border-0 bg-light p-2">
                        <div class="row g-0 align-items-center">
                            ...
                            <div class="col-9 col-sm-10 ps-3">
                                ...
                                <p class="text-muted small mb-0"><i class="bi bi-calendar3 me-1"></i>{{ $artikel->created_at->translatedFormat('d F Y') }}</p>
                            </div>
                        </div>
                    </div>
                    @empty
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="position-relative overflow-hidden rounded-3" style="height: 100px">
