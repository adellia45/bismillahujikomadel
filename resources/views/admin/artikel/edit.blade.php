...
<div class="container-fluid py-4">
    ...
    <!--form edit-->
    <form action="{{ route('admin.artikel.update', $artikels->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm p-3">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            id="judul"
                            name="judul"
                            value="{{ old('judul', $artikels->judul) }}"
                        ...
                        <div class="mb-3">
                            ...
                            id="tanggal_unggah"
                            name="tanggal_unggah"
                            value="{{ old('tanggal_unggah', \Carbon\Carbon::parse($artikels->tanggal_unggah)->format('Y-m-d')) }}"
                            required>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="border rounded-3 p-2 text-center bg-light mb-3 position-relative overflow-hidden" style="min-height: 220px; display: flex; align-items: center; justify-content: center;">
                                <img id="preview-foto" src="{{ $artikels->gambar ? asset('storage/' . $artikels->gambar) : '' }}" alt="Preview Foto" class="img-fluid rounded {{ $artikels->gambar ? '' : 'd-none' }} " style="max-height: 200px; object-fit: cover; width: 100%;">
                                <div id="preview-placeholder" class="text-muted {{ $artikels->gambar ? 'd-none' : ''}}">
